...
/**
 * Type-checks that the interaction has a guild and a user. Doing `if (!interaction.guild) return;` doesn't properly tell the compiler that `guild` is non-nullabe, this does.
 *
 * @param v Interaction.
